package datawave.ingest.balancer;
 ...
 */
public class ShardBalancer extends GroupBalancer {
    private static final Logger log = Logger.getLogger(ShardBalancer.class);
    private Collection<Pair<KeyExtent,Location>> tabletLocationCache;
    private Function<KeyExtent,String> partitioner;

    public ShardBalancer(String tableId) {
        super(TableId.of(tableId));
    }

    public ShardBalancer(TableId tableId) {
        super(tableId);
    }
