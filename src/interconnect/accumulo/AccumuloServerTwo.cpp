...
Scan *AccumuloServerFacadeV2::multiScan(
...
Scan *AccumuloServerFacadeV2::AccumuloServerFacadeV2::singleScan(
    std::atomic<bool> *isRunning,
    ScanRequest<ScanIdentifier<std::shared_ptr<cclient::data::KeyExtent>,
                               std::shared_ptr<cclient::data::Range>>>
        *request) {
...
Scan *AccumuloServerFacadeV2::beginScan(
    std::atomic<bool> *isRunning,
    ScanRequest<ScanIdentifier<std::shared_ptr<cclient::data::KeyExtent>,
                               std::shared_ptr<cclient::data::Range>>>
        *request) {
...
void *AccumuloServerFacadeV2::write(
...
bool AccumuloServerFacadeV2::dropUser(cclient::data::security::AuthInfo *auth,
                                      const std::string &user) {
  return v2_dropUser(auth, user);
}

bool AccumuloServerFacadeV2::changeUserPassword(
    cclient::data::security::AuthInfo *auth, const std::string &user,
    const std::string &password) {
  return v2_changeUserPassword(auth, user, password);
}
bool AccumuloServerFacadeV2::createUser(cclient::data::security::AuthInfo *auth,
                                        const std::string &user,
                                        const std::string &password) {
...
AccumuloServerFacadeV2::getTableConfiguration(
...
void AccumuloServerFacadeV2::v2_authenticate(
  ...
  } catch (const org::apache::accumulov2::core::clientImpl::thrift::
...
std::map<std::string, std::string>
AccumuloServerFacadeV2::v2_getNamespaceConfiguration(
    cclient::data::security::AuthInfo *auth, const std::string &nameSpaceName) {
  org::apache::accumulov2::core::trace::thrift::TInfo tinfo;
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
      ThriftV2Wrapper::convert(auth);
...
Scan *AccumuloServerFacadeV2::v2_singleScan(
    std::atomic<bool> *isRunning,
    ScanRequest<ScanIdentifier<std::shared_ptr<cclient::data::KeyExtent>,
                               std::shared_ptr<cclient::data::Range>>>
        *request) {
  ...
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
      getOrSetCredentialsV2(request->getCredentials());
  /**
   * void startScan(
   * ::org::apache::accumulov2::core::dataImpl::thrift::InitialScan& _return,
   * const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo,
   * const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials&
   * credentials, const
   ...
   * const std::vector<
   * ::org::apache::accumulov2::core::dataImpl::thrift::TColumn> & columns,
   * const int32_t batchSize, const std::vector<
   * ::org::apache::accumulov2::core::dataImpl::thrift::IterInfo> & ssiList,
   ...
   * const bool isolated, const int64_t readaheadThreshold,
   *
   *
   * const TSamplerConfiguration& samplerConfig, const int64_t batchTimeOut,
   *  const std::string& classLoaderContext, const std::map<std::string,
   * std::string> & executionHints);
   */
  org::apache::accumulov2::core::tabletserver::thrift::TSamplerConfiguration
      config;
  std::map<std::string, std::string> executionHints;

  logging::LOG_DEBUG(logger)
      << "extent is " << extent << " and range is " << range;

  try {
    tserverClient_V2->startScan(
        scan, scanId, creds, ThriftV2Wrapper::convert(extent),
        ThriftV2Wrapper::convert(range),
        ThriftV2Wrapper::convert(request->getColumns()), 1024,
        ThriftV2Wrapper::convert(iters), iterOptions,
        request->getAuthorizations()->getAuthorizations(), true, false,
        request->getBuffersize(), config, 1024 * 5, "", executionHints);
    ...
    logging::LOG_DEBUG(logger)
        << "Error on extent" << extent << " and range is " << range;
    throw te;
  }
  ...
  std::vector<std::shared_ptr<cclient::data::KeyValue>> *kvs =
      ThriftV2Wrapper::convert(results.results);
...
Scan *AccumuloServerFacadeV2::v2_multiScan(
    std::atomic<bool> *isRunning,
    ScanRequest<ScanIdentifier<std::shared_ptr<cclient::data::KeyExtent>,
                               std::shared_ptr<cclient::data::Range>>>
        *request) {
  ...
  try {
    tserverClient_V2->startMultiScan(
        scan, scanId, ThriftV2Wrapper::convert(request->getCredentials()),
        ThriftV2Wrapper::convert(request->getRangeIdentifiers()),
        ThriftV2Wrapper::convert(request->getColumns()),
        ThriftV2Wrapper::convert(iters), iterOptions,
        request->getAuthorizations()->getAuthorizations(), true, config,
    ...
    for (auto d : batch) {
      ...
      for (auto rng : d.second) {
        ...
        logging::LOG_DEBUG(logger) << "failed scan on extent is " << st.str()
                                   << " range is " << str.str();
      }
    }
    throw te;
...
AccumuloServerFacadeV2::getOrSetCredentialsV2(
  ...
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
      ThriftV2Wrapper::convert(convert);
  convertedMap_V2.insert(
      std::pair<
...
void AccumuloServerFacadeV2::v2_registerService(std::string instance,
                                                std::string clusterManagers) {
  client_V2->getZooKeepers(clusterManagers);
  client_V2->getInstanceId(instance);
}

Scan *AccumuloServerFacadeV2::v2_beginScan(
    std::atomic<bool> *isRunning,
    ScanRequest<ScanIdentifier<std::shared_ptr<cclient::data::KeyExtent>,
                               std::shared_ptr<cclient::data::Range>>>
        *request) {
...
Scan *AccumuloServerFacadeV2::v2_continueMultiScan(Scan *originalScan) {
  ...
  try {
    ...
    delete kvs;
  } catch (org::apache::accumulov2::core::tabletserver::thrift::
               NotServingTabletException &te) {
...
void *AccumuloServerFacadeV2::v2_write(
    cclient::data::security::AuthInfo *auth,
    std::map<cclient::data::KeyExtent,
             std::vector<std::shared_ptr<cclient::data::Mutation>>> *request) {
  org::apache::accumulov2::core::trace::thrift::TInfo tinfo;
  ...
  tinfo.parentId = 0;
  tinfo.traceId = rand();
  org::apache::accumulov2::core::dataImpl::thrift::UpdateID upId =
      tserverClient_V2->startUpdate(
          tinfo, creds,
          org::apache::accumulov2::core::tabletserver::thrift::TDurability::
              DEFAULT);
  for (auto it = request->begin(); it != request->end(); it++) {
    tserverClient_V2->applyUpdates(tinfo, upId,
                                   ThriftV2Wrapper::convert(it->first),
                                   ThriftV2Wrapper::convert(&it->second));
  }
...
bool AccumuloServerFacadeV2::v2_dropUser(
...
bool AccumuloServerFacadeV2::v2_changeUserPassword(
    cclient::data::security::AuthInfo *auth, std::string user,
    std::string password) {
  org::apache::accumulov2::core::trace::thrift::TInfo tinfo;
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
...
bool AccumuloServerFacadeV2::v2_createUser(
    cclient::data::security::AuthInfo *auth, std::string user,
    std::string password) {
  org::apache::accumulov2::core::trace::thrift::TInfo tinfo;
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
...
std::map<std::string, std::string>
AccumuloServerFacadeV2::v2_getTableConfiguration(
...
AccumuloServerFacadeV2::v2_getUserAuths(cclient::data::security::AuthInfo *auth,
                                        std::string user) {
  org::apache::accumulov2::core::trace::thrift::TInfo tinfo;
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
      ThriftV2Wrapper::convert(auth);
...
void AccumuloServerFacadeV2::v2_changeUserAuths(
    cclient::data::security::AuthInfo *auth, std::string user,
    cclient::data::security::Authorizations *auths) {
  org::apache::accumulov2::core::trace::thrift::TInfo tinfo;
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
  ...
  tinfo.parentId = 0;
  tinfo.traceId = rand();
  client_V2->changeAuthorizations(tinfo, creds, user,
                                  auths->getAuthorizations());
}

void AccumuloServerFacadeV2::v2_splitTablet(
    cclient::data::security::AuthInfo *auth,
  ...
  org::apache::accumulov2::core::dataImpl::thrift::TKeyExtent ke =
      ThriftV2Wrapper::convert(extent);
  tinfo.parentId = 0;
  tinfo.traceId = rand();
...
bool AccumuloServerFacadeV2::hasPermission(
    cclient::data::security::AuthInfo *auth, const std::string &user,
  ...
  logging::LOG_DEBUG(logger)
      ...
      << user;
  return tserverClient_V2->hasSystemPermission(tinfo, creds, user,
                                               to_base(perm));
}
bool AccumuloServerFacadeV2::hasPermission(
    cclient::data::security::AuthInfo *auth, const std::string &user,
  ...
  logging::LOG_DEBUG(logger)
      << "Looking up permission ( " << std::to_string(to_base(perm)) << ") for "
      << user << "on " << table;
  return tserverClient_V2->hasTablePermission(tinfo, creds, user, table,
                                              to_base(perm));
}
bool AccumuloServerFacadeV2::hasPermission(
    cclient::data::security::AuthInfo *auth, const std::string &user,
  ...
  logging::LOG_DEBUG(logger)
      << "Looking up permission ( " << std::to_string(to_base(perm)) << ") for "
      << user << " on " << nsp;
  return tserverClient_V2->hasNamespacePermission(tinfo, creds, user, nsp,
                                                  to_base(perm));
}
bool AccumuloServerFacadeV2::grant(cclient::data::security::AuthInfo *auth,
                                   const std::string user,
                                   cclient::data::SystemPermissions perm) {
  org::apache::accumulov2::core::trace::thrift::TInfo tinfo;
  tinfo.parentId = 0;
  ...
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
      ThriftV2Wrapper::convert(auth);
  tserverClient_V2->grantSystemPermission(tinfo, creds, user, to_base(perm));
  return true;
}
bool AccumuloServerFacadeV2::grant(cclient::data::security::AuthInfo *auth,
                                   const std::string user,
  ...
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
      ThriftV2Wrapper::convert(auth);
  tserverClient_V2->grantTablePermission(tinfo, creds, user, table,
                                         to_base(perm));
  return true;
}
bool AccumuloServerFacadeV2::grant(cclient::data::security::AuthInfo *auth,
  ...
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
      ThriftV2Wrapper::convert(auth);
  tserverClient_V2->grantNamespacePermission(tinfo, creds, user, nsp,
                                             to_base(perm));
  return true;
}

bool AccumuloServerFacadeV2::revoke(cclient::data::security::AuthInfo *auth,
                                    const std::string user,
                                    cclient::data::SystemPermissions perm) {
  org::apache::accumulov2::core::trace::thrift::TInfo tinfo;
  tinfo.parentId = 0;
  ...
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
      ThriftV2Wrapper::convert(auth);
  tserverClient_V2->revokeSystemPermission(tinfo, creds, user, to_base(perm));
  return true;
}
bool AccumuloServerFacadeV2::revoke(cclient::data::security::AuthInfo *auth,
                                    const std::string user,
  ...
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
      ThriftV2Wrapper::convert(auth);
  tserverClient_V2->revokeTablePermission(tinfo, creds, user, table,
                                          to_base(perm));
  return true;
}
bool AccumuloServerFacadeV2::revoke(cclient::data::security::AuthInfo *auth,
  ...
  org::apache::accumulov2::core::securityImpl::thrift::TCredentials creds =
      ThriftV2Wrapper::convert(auth);
  tserverClient_V2->revokeNamespacePermission(tinfo, creds, user, nsp,
                                              to_base(perm));
  return true;
}
