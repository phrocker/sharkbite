    ...
    switch (fid)
    {
      ...
      case 2:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->state = (MasterGoalState::type)ecast105;
...
uint32_t MasterClientService_waitForBalance_result::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  if (this->__isset.tnase) {
    xfer += oprot->writeFieldBegin("tnase", ::apache::thrift::protocol::T_STRUCT, 1);
    xfer += this->tnase.write(oprot);
    xfer += oprot->writeFieldEnd();
  }
  xfer += oprot->writeFieldStop();
    ...
    switch (fid)
    {
      ...
      case 3:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->status = (TabletLoadState::type)ecast106;
        ...
        if (ftype == ::apache::thrift::protocol::T_SET) {
          {
            ...
            {
              std::string _elem123;
              xfer += iprot->readString(_elem123);
              this->logsToWatch.insert(_elem123);
            }
...
uint32_t MasterClientService_drainReplicationTable_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("logsToWatch", ::apache::thrift::protocol::T_SET, 4);
  {
    ...
    for (_iter124 = this->logsToWatch.begin(); _iter124 != this->logsToWatch.end(); ++_iter124)
    {
...
uint32_t MasterClientService_drainReplicationTable_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  {
    xfer += oprot->writeSetBegin(::apache::thrift::protocol::T_STRING, static_cast<uint32_t>((*(this->logsToWatch)).size()));
    std::set<std::string> ::const_iterator _iter125;
    for (_iter125 = (*(this->logsToWatch)).begin(); _iter125 != (*(this->logsToWatch)).end(); ++_iter125)
    {
...
int64_t MasterClientServiceClient::initiateFlush(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName)
{
  send_initiateFlush(tinfo, credentials, tableName);
  return recv_initiateFlush();
}

void MasterClientServiceClient::send_initiateFlush(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::setTableProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::string& property, const std::string& value)
{
  send_setTableProperty(tinfo, credentials, tableName, property, value);
  recv_setTableProperty();
}

void MasterClientServiceClient::send_setTableProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::string& property, const std::string& value)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::removeTableProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::string& property)
{
  send_removeTableProperty(tinfo, credentials, tableName, property);
  recv_removeTableProperty();
}

void MasterClientServiceClient::send_removeTableProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::string& property)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::setNamespaceProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& ns, const std::string& property, const std::string& value)
{
  send_setNamespaceProperty(tinfo, credentials, ns, property, value);
  recv_setNamespaceProperty();
}

void MasterClientServiceClient::send_setNamespaceProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& ns, const std::string& property, const std::string& value)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::removeNamespaceProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& ns, const std::string& property)
{
  send_removeNamespaceProperty(tinfo, credentials, ns, property);
  recv_removeNamespaceProperty();
}

void MasterClientServiceClient::send_removeNamespaceProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& ns, const std::string& property)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::setMasterGoalState(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const MasterGoalState::type state)
{
  send_setMasterGoalState(tinfo, credentials, state);
  recv_setMasterGoalState();
}

void MasterClientServiceClient::send_setMasterGoalState(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const MasterGoalState::type state)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::shutdown(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const bool stopTabletServers)
{
  send_shutdown(tinfo, credentials, stopTabletServers);
  recv_shutdown();
}

void MasterClientServiceClient::send_shutdown(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const bool stopTabletServers)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::shutdownTabletServer(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tabletServer, const bool force)
{
  send_shutdownTabletServer(tinfo, credentials, tabletServer, force);
  recv_shutdownTabletServer();
}

void MasterClientServiceClient::send_shutdownTabletServer(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tabletServer, const bool force)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::setSystemProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& property, const std::string& value)
{
  send_setSystemProperty(tinfo, credentials, property, value);
  recv_setSystemProperty();
}

void MasterClientServiceClient::send_setSystemProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& property, const std::string& value)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::removeSystemProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& property)
{
  send_removeSystemProperty(tinfo, credentials, property);
  recv_removeSystemProperty();
}

void MasterClientServiceClient::send_removeSystemProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& property)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::getMasterStats(MasterMonitorInfo& _return, const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials)
{
  send_getMasterStats(tinfo, credentials);
  recv_getMasterStats(_return);
}

void MasterClientServiceClient::send_getMasterStats(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::waitForBalance(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo)
{
  send_waitForBalance(tinfo);
  recv_waitForBalance();
}

void MasterClientServiceClient::send_waitForBalance(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::reportSplitExtent(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& serverName, const TabletSplit& split)
{
  send_reportSplitExtent(tinfo, credentials, serverName, split);
}

void MasterClientServiceClient::send_reportSplitExtent(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& serverName, const TabletSplit& split)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::reportTabletStatus(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& serverName, const TabletLoadState::type status, const  ::org::apache::accumulov2::core::dataImpl::thrift::TKeyExtent& tablet)
{
  send_reportTabletStatus(tinfo, credentials, serverName, status, tablet);
}

void MasterClientServiceClient::send_reportTabletStatus(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& serverName, const TabletLoadState::type status, const  ::org::apache::accumulov2::core::dataImpl::thrift::TKeyExtent& tablet)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::getActiveTservers(std::vector<std::string> & _return, const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials)
{
  send_getActiveTservers(tinfo, credentials);
  recv_getActiveTservers(_return);
}

void MasterClientServiceClient::send_getActiveTservers(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::getDelegationToken( ::org::apache::accumulov2::core::securityImpl::thrift::TDelegationToken& _return, const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const  ::org::apache::accumulov2::core::securityImpl::thrift::TDelegationTokenConfig& cfg)
{
  send_getDelegationToken(tinfo, credentials, cfg);
  recv_getDelegationToken(_return);
}

void MasterClientServiceClient::send_getDelegationToken(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const  ::org::apache::accumulov2::core::securityImpl::thrift::TDelegationTokenConfig& cfg)
{
  int32_t cseqid = 0;
...
void MasterClientServiceClient::recv_getDelegationToken( ::org::apache::accumulov2::core::securityImpl::thrift::TDelegationToken& _return)
{
...
bool MasterClientServiceClient::drainReplicationTable(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tfino, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::set<std::string> & logsToWatch)
{
  send_drainReplicationTable(tfino, credentials, tableName, logsToWatch);
  return recv_drainReplicationTable();
}

void MasterClientServiceClient::send_drainReplicationTable(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tfino, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::set<std::string> & logsToWatch)
{
  int32_t cseqid = 0;
...
int64_t MasterClientServiceConcurrentClient::initiateFlush(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName)
{
  int32_t seqid = send_initiateFlush(tinfo, credentials, tableName);
  return recv_initiateFlush(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_initiateFlush(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName)
{
...
void MasterClientServiceConcurrentClient::waitForFlush(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::string& startRow, const std::string& endRow, const int64_t flushID, const int64_t maxLoops)
{
...
void MasterClientServiceConcurrentClient::setTableProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::string& property, const std::string& value)
{
  int32_t seqid = send_setTableProperty(tinfo, credentials, tableName, property, value);
  recv_setTableProperty(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_setTableProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::string& property, const std::string& value)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("setTableProperty", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::removeTableProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::string& property)
{
  int32_t seqid = send_removeTableProperty(tinfo, credentials, tableName, property);
  recv_removeTableProperty(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_removeTableProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::string& property)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("removeTableProperty", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::setNamespaceProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& ns, const std::string& property, const std::string& value)
{
  int32_t seqid = send_setNamespaceProperty(tinfo, credentials, ns, property, value);
  recv_setNamespaceProperty(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_setNamespaceProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& ns, const std::string& property, const std::string& value)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("setNamespaceProperty", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::removeNamespaceProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& ns, const std::string& property)
{
  int32_t seqid = send_removeNamespaceProperty(tinfo, credentials, ns, property);
  recv_removeNamespaceProperty(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_removeNamespaceProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& ns, const std::string& property)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("removeNamespaceProperty", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::setMasterGoalState(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const MasterGoalState::type state)
{
  int32_t seqid = send_setMasterGoalState(tinfo, credentials, state);
  recv_setMasterGoalState(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_setMasterGoalState(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const MasterGoalState::type state)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("setMasterGoalState", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::shutdown(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const bool stopTabletServers)
{
  int32_t seqid = send_shutdown(tinfo, credentials, stopTabletServers);
  recv_shutdown(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_shutdown(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const bool stopTabletServers)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("shutdown", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::shutdownTabletServer(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tabletServer, const bool force)
{
  int32_t seqid = send_shutdownTabletServer(tinfo, credentials, tabletServer, force);
  recv_shutdownTabletServer(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_shutdownTabletServer(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tabletServer, const bool force)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("shutdownTabletServer", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::setSystemProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& property, const std::string& value)
{
  int32_t seqid = send_setSystemProperty(tinfo, credentials, property, value);
  recv_setSystemProperty(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_setSystemProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& property, const std::string& value)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("setSystemProperty", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::removeSystemProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& property)
{
  int32_t seqid = send_removeSystemProperty(tinfo, credentials, property);
  recv_removeSystemProperty(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_removeSystemProperty(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& property)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("removeSystemProperty", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::getMasterStats(MasterMonitorInfo& _return, const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials)
{
  int32_t seqid = send_getMasterStats(tinfo, credentials);
  recv_getMasterStats(_return, seqid);
}

int32_t MasterClientServiceConcurrentClient::send_getMasterStats(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("getMasterStats", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::waitForBalance(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo)
{
  int32_t seqid = send_waitForBalance(tinfo);
  recv_waitForBalance(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_waitForBalance(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("waitForBalance", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::reportSplitExtent(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& serverName, const TabletSplit& split)
{
  send_reportSplitExtent(tinfo, credentials, serverName, split);
}

void MasterClientServiceConcurrentClient::send_reportSplitExtent(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& serverName, const TabletSplit& split)
{
  int32_t cseqid = 0;
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("reportSplitExtent", ::apache::thrift::protocol::T_ONEWAY, cseqid);
...
void MasterClientServiceConcurrentClient::reportTabletStatus(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& serverName, const TabletLoadState::type status, const  ::org::apache::accumulov2::core::dataImpl::thrift::TKeyExtent& tablet)
{
  send_reportTabletStatus(tinfo, credentials, serverName, status, tablet);
}

void MasterClientServiceConcurrentClient::send_reportTabletStatus(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& serverName, const TabletLoadState::type status, const  ::org::apache::accumulov2::core::dataImpl::thrift::TKeyExtent& tablet)
{
  int32_t cseqid = 0;
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("reportTabletStatus", ::apache::thrift::protocol::T_ONEWAY, cseqid);
...
void MasterClientServiceConcurrentClient::getActiveTservers(std::vector<std::string> & _return, const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials)
{
  int32_t seqid = send_getActiveTservers(tinfo, credentials);
  recv_getActiveTservers(_return, seqid);
}

int32_t MasterClientServiceConcurrentClient::send_getActiveTservers(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("getActiveTservers", ::apache::thrift::protocol::T_CALL, cseqid);
...
int32_t MasterClientServiceConcurrentClient::send_getDelegationToken(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const  ::org::apache::accumulov2::core::securityImpl::thrift::TDelegationTokenConfig& cfg)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("getDelegationToken", ::apache::thrift::protocol::T_CALL, cseqid);
...
void MasterClientServiceConcurrentClient::recv_getDelegationToken( ::org::apache::accumulov2::core::securityImpl::thrift::TDelegationToken& _return, const int32_t seqid)
{
...
bool MasterClientServiceConcurrentClient::drainReplicationTable(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tfino, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::set<std::string> & logsToWatch)
{
  int32_t seqid = send_drainReplicationTable(tfino, credentials, tableName, logsToWatch);
  return recv_drainReplicationTable(seqid);
}

int32_t MasterClientServiceConcurrentClient::send_drainReplicationTable(const  ::org::apache::accumulov2::core::trace::thrift::TInfo& tfino, const  ::org::apache::accumulov2::core::securityImpl::thrift::TCredentials& credentials, const std::string& tableName, const std::set<std::string> & logsToWatch)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("drainReplicationTable", ::apache::thrift::protocol::T_CALL, cseqid);
