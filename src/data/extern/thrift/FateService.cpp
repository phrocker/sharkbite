 ...
 *  @generated
 */
#include "data/extern/thrift/FateService.h"
        ...
        if (ftype == ::apache::thrift::protocol::T_LIST) {
          {
            ...
            {
              xfer += iprot->readBinary(this->arguments[_i78]);
            }
...
uint32_t FateService_executeFateOperation_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("arguments", ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    for (_iter86 = this->arguments.begin(); _iter86 != this->arguments.end(); ++_iter86)
    {
  ...
  xfer += oprot->writeFieldBegin("options", ::apache::thrift::protocol::T_MAP, 5);
  {
    ...
    for (_iter87 = this->options.begin(); _iter87 != this->options.end(); ++_iter87)
    {
...
uint32_t FateService_executeFateOperation_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("arguments", ::apache::thrift::protocol::T_LIST, 4);
  {
    ...
    for (_iter88 = (*(this->arguments)).begin(); _iter88 != (*(this->arguments)).end(); ++_iter88)
    {
  ...
  xfer += oprot->writeFieldBegin("options", ::apache::thrift::protocol::T_MAP, 5);
  {
    ...
    for (_iter89 = (*(this->options)).begin(); _iter89 != (*(this->options)).end(); ++_iter89)
    {
...
int64_t FateServiceClient::beginFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials)
{
  send_beginFateOperation(tinfo, credentials);
  return recv_beginFateOperation();
}

void FateServiceClient::send_beginFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials)
{
  int32_t cseqid = 0;
...
void FateServiceClient::send_executeFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials, const int64_t opid, const FateOperation::type op, const std::vector<std::string> & arguments, const std::map<std::string, std::string> & options, const bool autoClean)
{
  int32_t cseqid = 0;
...
void FateServiceClient::waitForFateOperation(std::string& _return, const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials, const int64_t opid)
{
  send_waitForFateOperation(tinfo, credentials, opid);
  recv_waitForFateOperation(_return);
}

void FateServiceClient::send_waitForFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials, const int64_t opid)
{
  int32_t cseqid = 0;
...
void FateServiceClient::finishFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials, const int64_t opid)
{
  send_finishFateOperation(tinfo, credentials, opid);
  recv_finishFateOperation();
}

void FateServiceClient::send_finishFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials, const int64_t opid)
{
  int32_t cseqid = 0;
...
int64_t FateServiceConcurrentClient::beginFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials)
{
  int32_t seqid = send_beginFateOperation(tinfo, credentials);
  return recv_beginFateOperation(seqid);
}

int32_t FateServiceConcurrentClient::send_beginFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials)
{
...
int32_t FateServiceConcurrentClient::send_executeFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials, const int64_t opid, const FateOperation::type op, const std::vector<std::string> & arguments, const std::map<std::string, std::string> & options, const bool autoClean)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("executeFateOperation", ::apache::thrift::protocol::T_CALL, cseqid);
...
void FateServiceConcurrentClient::waitForFateOperation(std::string& _return, const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials, const int64_t opid)
{
  int32_t seqid = send_waitForFateOperation(tinfo, credentials, opid);
  recv_waitForFateOperation(_return, seqid);
}

int32_t FateServiceConcurrentClient::send_waitForFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials, const int64_t opid)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("waitForFateOperation", ::apache::thrift::protocol::T_CALL, cseqid);
...
void FateServiceConcurrentClient::finishFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials, const int64_t opid)
{
  int32_t seqid = send_finishFateOperation(tinfo, credentials, opid);
  recv_finishFateOperation(seqid);
}

int32_t FateServiceConcurrentClient::send_finishFateOperation(const  ::org::apache::accumulo::core::trace::thrift::TInfo& tinfo, const  ::org::apache::accumulo::core::security::thrift::TCredentials& credentials, const int64_t opid)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("finishFateOperation", ::apache::thrift::protocol::T_CALL, cseqid);
