...
void UpdateErrors::__set_authorizationFailures(const std::map<TKeyExtent,  ::org::apache::accumulo::core::client::impl::thrift::SecurityErrorCode::type> & val) {
        ...
        if (ftype == ::apache::thrift::protocol::T_MAP) {
          {
            ...
            for (_i84 = 0; _i84 < _size80; ++_i84)
            {
              ...
              xfer += _key85.read(iprot);
               ::org::apache::accumulo::core::client::impl::thrift::SecurityErrorCode::type& _val86 = this->authorizationFailures[_key85];
              int32_t ecast87;
              xfer += iprot->readI32(ecast87);
              _val86 = ( ::org::apache::accumulo::core::client::impl::thrift::SecurityErrorCode::type)ecast87;
            }
            xfer += iprot->readMapEnd();
          }
...
uint32_t UpdateErrors::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("authorizationFailures", ::apache::thrift::protocol::T_MAP, 3);
  {
    ...
    std::map<TKeyExtent,  ::org::apache::accumulo::core::client::impl::thrift::SecurityErrorCode::type> ::const_iterator _iter90;
