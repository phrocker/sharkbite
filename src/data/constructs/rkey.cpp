...
uint64_t
RelativeKey::read (streams::InputStream *stream)
{
...
void
RelativeKey::readPrefix (streams::InputStream *stream, std::vector<char> *row, std::vector<char> *prevRow)
{
...
uint64_t
RelativeKey::write (streams::OutputStream *outStream)
{
