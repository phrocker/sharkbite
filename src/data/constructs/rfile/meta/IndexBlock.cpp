...
std::shared_ptr<SerializedIndex> IndexBlock::getIndex() { return index; }
...
std::shared_ptr<KeyIndex> IndexBlock::getKeyIndex() { return keyIndex; }

int IndexBlock::getLevel() { return level; }

int IndexBlock::getOffset() { return offset; }

bool IndexBlock::hasNextKey() { return hasNext; }
