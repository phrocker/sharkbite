...
LocalityGroupMetaData::LocalityGroupMetaData (cclient::data::compression::Compressor *compressorRef,
 ...
 **/
uint64_t
LocalityGroupMetaData::read (cclient::data::streams::InputStream *in)
{
 ...
 **/
uint64_t
LocalityGroupMetaData::write (cclient::data::streams::DataOutputStream *outStream)
{
