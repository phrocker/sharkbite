...
scanner = AccumuloScanner(args.instance,args.zookeepers,args.username,password,table,"")

scanner.fetch_range(Range("a",True,"\uffff",False))
df = read_accumulo(scanner,None,None,25)
