...
class AccumuloCoordinatorFacadeV2 : public AccumuloCoordinatorFacade {
 private:
  std::shared_ptr<logging::Logger> logger;

  std::shared_ptr<
      org::apache::accumulov2::core::master::thrift::MasterClientServiceClient>
      coordinatorClientV2;

  bool v2_createTable(cclient::data::security::AuthInfo *auth,
    ...
    } catch (org::apache::accumulov2::core::clientImpl::thrift::
                 ThriftTableOperationException &e) {
      switch (e.type) {
        case org::apache::accumulov2::core::clientImpl::thrift::
  ...
  bool v2_compactFallBack(cclient::data::security::AuthInfo *auth,
  ...
  bool v2_compact(cclient::data::security::AuthInfo *auth,
                  const std::string &table, const std::string &startrow,
                  const std::string &endrow, bool wait) {
    std::vector<std::string> tableArgs;
    tableArgs.push_back(table);
    ...
    std::shared_ptr<apache::thrift::protocol::TBinaryProtocol> binaryProtcol(
        new apache::thrift::protocol::TBinaryProtocol(strBuffer));
    org::apache::accumulov2::core::tabletserver::thrift::IteratorConfig config;
    org::apache::accumulov2::core::tabletserver::thrift::TIteratorSetting
        setting;
    setting.name = "vers";
    setting.priority = 10;
  ...
  bool v2_flush(cclient::data::security::AuthInfo *auth,
                const std::string &table, const std::string &startrow,
                const std::string &endrow, bool wait) {
    ...
    int64_t flushId = 0;
    try {
      flushId = coordinatorClientV2->initiateFlush(transId, creds, table);
    ...
    while (true) {
      try {
        ...
        transId.traceId++;
        recreateCoordinatorTransport();
        coordinatorClientV2->waitForFlush(transId, creds, table, startrow,
  ...
  bool v2_removeTable(cclient::data::security::AuthInfo *auth,
                      const std::string &table) {
    std::vector<std::string> tableArgs;
    tableArgs.push_back(table);
    std::map<std::string, std::string> options;
  ...
  void v2_removeTableProperty(cclient::data::security::AuthInfo *auth,
                              const std::string &table,
    ...
    coordinatorClientV2->removeTableProperty(transId, creds, table, property);
  }

  void v2_setTableProperty(cclient::data::security::AuthInfo *auth,
                           const std::string &table,
                           const std::string &property,
    ...
    coordinatorClientV2->setTableProperty(transId, creds, table, property,
                                          value);
  }
  ...
  void v2_removeNamespaceProperty(cclient::data::security::AuthInfo *auth,
    ...
    coordinatorClientV2->removeNamespaceProperty(transId, creds, nameSpaceName,
                                                 property);
  }
  ...
  void v2_setNamespaceProperty(cclient::data::security::AuthInfo *auth,
    ...
    coordinatorClientV2->setNamespaceProperty(transId, creds, nameSpaceName,
                                              property, value);
  }

  void v2_createCoordinatorClient(
    ...
    auto protocolPtr =
        std::make_shared<apache::thrift::protocol::TCompactProtocol>(
            underlyingTransport);
    coordinatorClientV2 =
        std::make_shared<org::apache::accumulov2::core::master::thrift::
                             MasterClientServiceClient>(protocolPtr);
  }

 public:
  AccumuloCoordinatorFacadeV2(
      const std::string &host, std::function<void()> fx,
      std::function<std::shared_ptr<apache::thrift::transport::TTransport>()>
          tfx)
      : AccumuloCoordinatorFacade(host, ACCUMULO_TWO, fx, tfx),
        logger(
            logging::LoggerFactory<AccumuloCoordinatorFacadeV2>::getLogger()) {}
  ...
  virtual cclient::data::AccumuloInfo getStatistics(
    ...
    coordinatorClientV2->getMasterStats(stats, transId, creds);
    return ThriftV2Wrapper::convert(stats);
  }
  ...
  std::string v2_doFateOperations(
      cclient::data::security::AuthInfo *auth, AccumuloFateOperation mytype,
      const std::vector<std::string> &tableArgs,
      const std::map<std::string, std::string> &options, bool wait = false) {
    auto myMasterClient = coordinatorClientV2;

    org::apache::accumulov2::core::master::thrift::FateOperation::type type =
        org::apache::accumulov2::core::master::thrift::FateOperation::type::
            TABLE_CREATE;
    switch (mytype) {
      case TABLE_CREATE:
        type = org::apache::accumulov2::core::master::thrift::FateOperation::
            type::TABLE_CREATE;
        break;
      case TABLE_CLONE:
        type = org::apache::accumulov2::core::master::thrift::FateOperation::
      ...
      while (true) {
        ...
        try {
          auto protocolPtr =
              std::make_shared<apache::thrift::protocol::TCompactProtocol>(
                  myTransport);
          org::apache::accumulov2::core::master::thrift::
              MasterClientServiceClient waitClient(protocolPtr);
