...
public:
	...
	bool
	createTable (cclient::data::security::AuthInfo *auth, std::string table)
	{
	...
	bool
	importDirectory (cclient::data::security::AuthInfo *auth, std::string table, std::string dir,
	...
	bool
	removeTable (cclient::data::security::AuthInfo *auth, std::string table)
	{
