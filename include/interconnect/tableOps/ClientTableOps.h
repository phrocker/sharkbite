 ...
 */
class AccumuloTableOperations: public interconnect::TableOperations<cclient::data::KeyValue,
...
public:
	 ...
	 **/
	virtual int8_t compact(std::string startRow, std::string endRow, bool wait);
	 ...
	 * 0 successs
	 */
	virtual int8_t setProperty(std::string property, std::string value);
	 ...
	 * success
	 */
	virtual int8_t removeProperty(std::string property);
	 ...
	 * @return new scanner
	 **/
	std::unique_ptr<scanners::Source<cclient::data::KeyValue, scanners::ResultBlock<cclient::data::KeyValue>>> createScanner(
	 ...
	 */
	std::unique_ptr<writer::Sink<cclient::data::KeyValue>> createWriter(cclient::data::security::Authorizations *auths,
	                              uint16_t threads);
