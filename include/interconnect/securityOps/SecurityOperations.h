...
public:
	 ...
	 **/
	SecurityOperations(cclient::data::security::AuthInfo *creds, cclient::data::Instance *instance,
	               CachedTransport<interconnect::AccumuloMasterTransporter> *interface, TransportPool<interconnect::AccumuloMasterTransporter> *distributedConnector) : credentials(creds), myInstance(instance),clientInterface(interface->getTransport())
	{
