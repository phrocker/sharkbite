...
inline std::ostream& operator<<(std::ostream& out, const TCredentials& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const TAuthenticationTokenIdentifier& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const TAuthenticationKey& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const TDelegationToken& obj)
{
  obj.printTo(out);
  return out;
}
...
inline std::ostream& operator<<(std::ostream& out, const TDelegationTokenConfig& obj)
{
  obj.printTo(out);
  return out;
}
