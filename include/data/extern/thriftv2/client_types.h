 ...
 *  @generated
 */
#ifndef client_TYPES_V2H
#define client_TYPES_V2H
...
class ThriftNotActiveServiceException;
...
class ThriftNotActiveServiceException : public ::apache::thrift::TException {
 public:

  ThriftNotActiveServiceException(const ThriftNotActiveServiceException&);
  ThriftNotActiveServiceException& operator=(const ThriftNotActiveServiceException&);
  ThriftNotActiveServiceException() {
  }

  virtual ~ThriftNotActiveServiceException() throw();

  bool operator == (const ThriftNotActiveServiceException & /* rhs */) const
  {
    return true;
  }
  bool operator != (const ThriftNotActiveServiceException &rhs) const {
  ...
  bool operator < (const ThriftNotActiveServiceException & ) const;
...
class TDiskUsage : public virtual ::apache::thrift::TBase {
 public:
