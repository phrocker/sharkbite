...
public:
   ...
   */
  static std::shared_ptr<cclient::data::streams::KeyValueIterator> openManySequential(const std::vector<std::string>  &rfiles,int versions=0, bool withDeletes = false, bool propogate = true);
