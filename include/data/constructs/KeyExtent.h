...
public:
    ...
    /**
      ...
      **/
    explicit KeyExtent (KeyExtent *copy) : tableId(copy->getTableId()), endRow ( copy->getEndRow() ), prevEndRow(copy->getPrevEndRow())
    {
    }
     ...
     **/
    static std::string
    createMetadataEntry (std::string table, std::string row)
    {
...
protected:
     ...
     **/
    void
    decodeMetadataRow (std::string flattenedText)
    {
        int16_t semiPos = -1;
        int16_t ltPos = -1;
