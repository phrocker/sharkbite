...
function(use_libre_ssl SOURCE_DIR BINARY_DIR)
	...
	set_target_properties(crypto PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/dependencies/libressl-install/lib/${BYPRODUCT_PREFIX}crypto${BYPRODUCT_SUFFIX}")
	add_dependencies(crypto libressl-portable)
					
	add_library(ssl STATIC IMPORTED)
	set_target_properties(ssl PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/dependencies/libressl-install/lib/${BYPRODUCT_PREFIX}ssl${BYPRODUCT_SUFFIX}")
	...
	set_target_properties(tls PROPERTIES IMPORTED_LOCATION "${BINARY_DIR}/dependencies/libressl-install/lib/${BYPRODUCT_PREFIX}tls${BYPRODUCT_SUFFIX}")
