...
htmlhelp_basename = 'Sharkbitedoc'
...
latex_documents = [
    (master_doc, 'Sharkbite.tex', 'Sharkbite Documentation',
     'Marc Parisi', 'manual'),
]
...
man_pages = [
    (master_doc, 'sharkbite', 'Sharkbite Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'Sharkbite', 'Sharkbite Documentation',
     author, 'Sharkbite', 'One line description of project.',
     'Miscellaneous'),
]
